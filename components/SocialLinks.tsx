...
const SocialLinks = () => {
  return (
    <div className="fixed hidden shadow-md shadow-white lg:flex flex-col border lg:right-8 xl:right-20 bg-black rounded-full gap-7 px-3 py-5">
      {links.map((link, i) => {
        ...
        return (
          <a
            key={i}
            href={href}
            className="text-4xl hover:scale-110 duration-300"
            target="_blank"
          >
            {icon}
          </a>
